...
const descriptions: Record<Locale, Record<string, string>> = {
  en: {
    ...
    guides: "Practical, original guides for image cropping, alignment, output quality, privacy and consistent multi-image workflows.",
    resources: "Free aspect-ratio and enlargement calculators for planning image crops and output dimensions.",
  ...
  ko: {
    ...
    guides: "이미지 크롭, 전후 정렬, 출력 화질, 개인정보와 다중 이미지 작업에 관한 실용적인 심층 가이드입니다.",
    resources: "이미지 크롭을 계획할 수 있는 무료 비율 계산기와 확대 위험 확인 도구입니다.",
  ...
  ja: {
    ...
    guides: "切り抜き、整列、出力品質、プライバシー、複数画像作業に関する独自の詳細ガイドです。",
    resources: "切り抜き計画に使える無料の比率計算と拡大確認ツールです。",
  ...
  es: {
    ...
    guides: "Guías originales y detalladas sobre recorte, alineación, calidad, privacidad y series de imágenes.",
    resources: "Calculadoras gratuitas de proporción y ampliación para planificar recortes y salidas.",
